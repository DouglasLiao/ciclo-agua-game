...
const temas = [
  {
    ...
    data: makeData({
      ...
      perguntas: [
        {
          texto: 'Qual é a estrela do sistema solar?',
          alternativas: ['Sol', 'Terra', 'Marte'],
          correta: 0
        },
  ...
  },
  {
    ...
    data: makeData({
      ...
      perguntas: [
        {
          texto: 'Quem produz matéria orgânica?',
          alternativas: ['Consumidor', 'Produtor', 'Decompositor'],
          correta: 1
        },
  ...
  },
  {
    ...
    data: makeData({
      ...
      perguntas: [
        {
          texto: 'Qual a fonte de energia?',
          alternativas: ['Luz Solar', 'Água', 'Glicose'],
          correta: 0
        },
        ...
        {
          texto: 'Molécula energética gerada?',
          alternativas: ['C6H12O6', 'CO2', 'Luz'],
          correta: 0
        }
      ],
